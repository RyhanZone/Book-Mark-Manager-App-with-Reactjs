...
export default function MainSection({ HomeActive, setMenuOpen, MenuOpen , darkMode, setDarkMode, IsFormActive, setIsFormActive, bookmarksList ,setBookmarks}) {
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0">
        {HomeActive ? <Home bookmarks={bookmarksList} setBookmarks={setBookmarks}/> : <ArchivedBookmarks />}
      </div>
    </div>
  );
}
