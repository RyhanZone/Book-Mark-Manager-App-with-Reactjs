...
export default function Dashboard({ darkMode, setDarkMode }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className={`absolute w-full h-screen bg-[#131313B2] dark:bg-[#131313B2] ${IsFormActive ? "flex" : "hidden"} justify-center items-center`}>
        <div className="w-[570px] h-auto py-[var(--spacing-500)] px-[var(--spacing-400)] border border-[var(--n-l-100)] dark:border-[var(--n-d-500)] bg-[var(--n-l-0)] dark:bg-[var(--n-d-800)] rounded-[var(--b-r-12)] flex flex-col gap-[var(--spacing-400)]">
          ...
          <div className="flex flex-col gap-[var(--spacing-075)]">
            <div className="flex justify-between">
              ...
              <div onClick={()=>{setIsFormActive(false)}} className="border flex justify-center items-center rounded h-8 w-8 border-[var(--n-l-400)] dark:border-[var(--n-d-500)] ">
          ...
          <div className="flex flex-col gap-[var(--spacing-250)]">
            <InputFild labelTxt={"Title *"} inputType={"text"} />
            <TextAreaFilds labeltxt={"Description"} />
            <InputFild labelTxt={"Website Url*"} inputType={"text"} />
            <InputFild labelTxt={"Tags *"} inputType={"text"} />
          </div>
          {/* buttons */}
          <div className="flex gap-[var(--spacing-200)] ">
            <SecondaryButton onClick={()=>{setIsFormActive(false)}} text={"Cancel"} />
            <PrimaryButton text={"Add Bookmark"} />
          </div>
        </div>
      </div>
    </div>
